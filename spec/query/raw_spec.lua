...
describe("Query:where() — raw SQL validation", function()
    ...
    it("blocks DROP TABLE injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "DROP", 1, true) ~= nil)
    end)
    ...
    it("blocks DELETE FROM injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "DELETE", 1, true) ~= nil)
    end)
    ...
    it("blocks UPDATE injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "UPDATE", 1, true) ~= nil)
    end)
    ...
    it("blocks ALTER TABLE injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "ALTER", 1, true) ~= nil)
    end)
    ...
    it("blocks TRUNCATE injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "TRUNCATE", 1, true) ~= nil)
    end)
    ...
    it("blocks INSERT INTO injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "INSERT", 1, true) ~= nil)
    end)
    ...
    it("blocks CREATE TABLE injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "CREATE", 1, true) ~= nil)
    end)
    ...
    it("blocks GRANT injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "GRANT", 1, true) ~= nil)
    end)
    ...
    it("blocks EXECUTE injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "EXECUTE", 1, true) ~= nil)
    end)
    ...
    it("blocks REVOKE injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "REVOKE", 1, true) ~= nil)
    end)
    ...
    it("still blocks UNION SELECT injection", function()
        ...
        assert.is_false(ok)
        assert.is_true(string.find(tostring(err or ""), "UNION", 1, true) ~= nil)
    end)
